export const metamorphoAbi = [
  ...
  { inputs: [], name: 'MarketNotEnabled', type: 'error' },
  ...
  { inputs: [], name: 'WithdrawMorphoFailed', type: 'error' },
  { inputs: [], name: 'ZeroAddress', type: 'error' },
  { inputs: [], name: 'ZeroFeeRecipient', type: 'error' },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint256', name: 'feeShares', type: 'uint256' }],
    name: 'AccrueFee',
    type: 'event'
  },
  {
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint256', name: 'newTotalAssets', type: 'uint256' }],
  ...
  },
  {
    ...
    name: 'config',
    outputs: [
      { internalType: 'uint192', name: 'cap', type: 'uint192' },
      { internalType: 'bool', name: 'enabled', type: 'bool' },
      { internalType: 'uint56', name: 'removableAt', type: 'uint56' }
    ],
    stateMutability: 'view',
    type: 'function'
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint56', name: 'validAt', type: 'uint56' }
    ],
    stateMutability: 'view',
    type: 'function'
  },
